...
export const APIKEY_PROVIDERS = {
  ...
  ollama: { id: "ollama", alias: "ollama", name: "Ollama Cloud", icon: "cloud", color: "#ffffffff", textIcon: "OL", website: "https://ollama.com", notice: { text: "Pro $20/mo · Max $100/mo. Supports multi-key rotation.", apiKeyUrl: "https://ollama.com/settings/keys" }, serviceKinds: ["llm"] },
