...
export const MODEL_PRICING = {
  ...
  // === Ollama Cloud ===
  "gpt-oss:120b":                 { input: 0.50,  output: 2.00,  cached: 0.25,  reasoning: 3.00,   cache_creation: 0.50  },
  "kimi-k2.5":                    { input: 1.20,  output: 4.80,  cached: 0.60,  reasoning: 7.20,   cache_creation: 1.20  },
  "glm-5":                        { input: 1.00,  output: 4.00,  cached: 0.50,  reasoning: 6.00,   cache_creation: 1.00  },
  "minimax-m2.5":                 { input: 0.50,  output: 2.00,  cached: 0.25,  reasoning: 3.00,   cache_creation: 0.50  },
  "glm-4.7-flash":                { input: 0.75,  output: 3.00,  cached: 0.375, reasoning: 4.50,   cache_creation: 0.75  },
  "qwen3.5":                      { input: 0.50,  output: 2.00,  cached: 0.25,  reasoning: 3.00,   cache_creation: 0.50  },
};
...
export const PATTERN_PRICING = [
  ...
  // --- Gemma ---
  { pattern: "gemma*",          pricing: { input: 0.15,  output: 0.60,  cached: 0.075, reasoning: 0.90,   cache_creation: 0.15  } },

  // --- Mistral / Ministral ---
  { pattern: "mistral-large-*", pricing: { input: 2.00,  output: 6.00,  cached: 1.00,  reasoning: 9.00,   cache_creation: 2.00  } },
  { pattern: "mistral*",        pricing: { input: 0.30,  output: 0.90,  cached: 0.15,  reasoning: 1.35,   cache_creation: 0.30  } },
  { pattern: "ministral-*",     pricing: { input: 0.15,  output: 0.45,  cached: 0.075, reasoning: 0.675,  cache_creation: 0.15  } },

  // --- Nemotron ---
  { pattern: "nemotron-*super", pricing: { input: 0.50,  output: 1.50,  cached: 0.25,  reasoning: 2.25,   cache_creation: 0.50  } },
  { pattern: "nemotron-*",      pricing: { input: 0.25,  output: 0.75,  cached: 0.125, reasoning: 1.125,  cache_creation: 0.25  } },

  // --- Cogito ---
  { pattern: "cogito-*",        pricing: { input: 0.50,  output: 1.50,  cached: 0.25,  reasoning: 2.25,   cache_creation: 0.50  } },

  // --- Devstral ---
  { pattern: "devstral-small-*",pricing: { input: 0.15,  output: 0.45,  cached: 0.075, reasoning: 0.675,  cache_creation: 0.15  } },
  { pattern: "devstral-*",      pricing: { input: 0.30,  output: 0.90,  cached: 0.15,  reasoning: 1.35,   cache_creation: 0.30  } },

  // --- RNJ ---
  { pattern: "rnj-*",           pricing: { input: 0.10,  output: 0.30,  cached: 0.05,  reasoning: 0.45,   cache_creation: 0.10  } },

  // --- GPT OSS ---
  { pattern: "gpt-oss*",        pricing: { input: 2.00,  output: 8.00,  cached: 1.00,  reasoning: 12.00,  cache_creation: 2.00  } },
