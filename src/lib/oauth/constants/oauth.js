...
export const GEMINI_CONFIG = {
  clientId: process.env.GEMINI_CLIENT_ID || "YOUR-GOOGLE-CLIENT-ID.apps.googleusercontent.com",
  clientSecret: process.env.GEMINI_CLIENT_SECRET || "YOUR-GOOGLE-CLIENT-SECRET",
...
export const IFLOW_CONFIG = {
  ...
  clientSecret: process.env.IFLOW_CLIENT_SECRET || "YOUR-IFLOW-CLIENT-SECRET",
